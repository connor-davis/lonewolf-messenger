      ...
      <div class="flex w-full h-full bg-gray-200 dark:bg-gray-900 overflow-hidden">
        <div
          class={`flex flex-col flex-none transition-wp duration-500 ease ${
            menuActive() ? 'w-5/6 p-3 space-y-3' : 'w-0 space-y-3'
          } lg:w-96 lg:p-3 lg:space-y-3 h-full bg-gray-200 dark:bg-gray-900 overflow-y-auto overflow-x-hidden`}
        >
          <div
        ...
        >
          <div class="w-screen lg:w-full h-full overflow-y-auto">
            <Outlet />
          </div>
        </div>
      </div>
