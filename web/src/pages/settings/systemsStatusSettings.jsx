      ...
      <div class="flex flex-col lg:flex-row w-full h-full p-3 lg:px-10 space-y-4 lg:space-y-0 space-x-0 lg:space-x-4 overflow-y-auto">
        <div class="flex flex-col space-y-4 w-full lg:w-3/5">
          <div class="flex items-center space-x-3">
            <div class="w-full uppercase text-gray-400 dark:text-gray-300">
              IPFS
            </div>
          ...
          <div class="flex items-center space-x-3">
            ...
            <div class="relative">
              <div
                class={`flex-none w-3 h-3 rounded-full ${
                  swarmConnectivity() === 'bad' && 'bg-red-500'
                } ${swarmConnectivity() === 'good' && 'bg-yellow-400'} ${
                  swarmConnectivity() === 'excellent' && 'bg-green-400'
                } animate-ping`}
              ></div>

              <div
                class={`absolute top-0 left-0 flex-none w-3 h-3 rounded-full ${
                  swarmConnectivity() === 'bad' && 'bg-red-500'
                } ${swarmConnectivity() === 'good' && 'bg-yellow-400'} ${
                  swarmConnectivity() === 'excellent' && 'bg-green-400'
                }`}
